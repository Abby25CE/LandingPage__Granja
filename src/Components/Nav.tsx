  ...
  return (
    <main className="pt-24">
      <nav
        ...
        className="glass-nav fixed left-0 right-0 top-0 z-10 mx-auto overflow-hidden border-[1px] border-white/10 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur"
      >
